...
```{r, fig.height=12, echo=FALSE, fig.cap="FCMR-plot: old data vs. new data"}
par(mfrow=c(2,2))
...
----------------------
```{r, results='asis'}
# report build command: # source('init1.R'); source('init2.R'); build.report(c(5), do.pdf=TRUE, toc=TRUE);
