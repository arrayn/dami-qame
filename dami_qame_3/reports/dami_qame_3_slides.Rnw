...
\title[Short title]{Data Mining - Problem 3 - Definitions round} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\textit{Arto Nissinen, Eric Andrews, Mirva Toivonen, Quan Nguyen}
}
...
\SweaveInput{../group/skeleton_slides}
\section{Example section}
\SweaveInput{../group/example1_slides}
