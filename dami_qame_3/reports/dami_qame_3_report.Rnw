...
% for our own implementation hacking
% \section{Own implementation hackings}
% \SweaveInput{../arto/arto_implementation_report}

\SweaveInput{../eric/implementation.Rnw}

\SweaveInput{../arto/examples_with_library_report}
