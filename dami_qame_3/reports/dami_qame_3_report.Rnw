...
\title{Data Mining Problem 3 QAME Group Report} % Your article title
...
\SweaveInput{../arto/init}
\SweaveInput{../group/intro}

\section{Pattern specification}
\SweaveInput{../arto/format_conversion_report}
\SweaveInput{../eric/specification.Rnw}
\subsection{Pseudo algorithms}
\SweaveInput{../quan/pseudo_code_report}

\section{Implementations}
\SweaveInput{../eric/implementation.Rnw}

\section{Data mining}
\SweaveInput{../arto/exploration_report}
\SweaveInput{../eric/sequence_results.Rnw}
\SweaveInput{../arto/seqrules1_report}
