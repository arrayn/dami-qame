...
\title[DAMI Problem 3 - Second round]{Data Mining - Problem 3 - Second round} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\SweaveInput{../eric/implementation_real_slides.Rnw}

\section{Data exploration}
\SweaveInput{../arto/exploration_slides}

\section{Sequence rules}
\SweaveInput{../arto/seqrules1_slides}
