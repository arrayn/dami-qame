...
\title[DAMI Problem 4 - Negative patterns]{Data Mining - Problem 4 - Negative patterns} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\SweaveInput{../arto/negap1_slides}
